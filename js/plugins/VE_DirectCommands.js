...
Imported['VE - Direct Commands'] = '1.01';
...
/*:
 *------------------------------------------------------------------------------ 
 * @plugindesc v1.01 - Set commands that uses item or skills directly.
 * @author Victor Sant
 *
 * ------------------------------------------------------------------------------
 * @help 
...
(function() {
	...
	VictorEngine.DirectCommands.processValues = function(match, data, code) {
		var result = {};
