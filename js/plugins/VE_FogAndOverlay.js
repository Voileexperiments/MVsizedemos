...
Imported['VE - Fog And Overlay'] = '1.05';
...
(function() {
	...
	DataManager.loadDatabase = function() {
		...
		PluginManager.requiredPlugin.call(PluginManager, 'VE - Light Effects', 'VE - Basic Module', '1.16');
	};
...
/*:
 *------------------------------------------------------------------------------ 
 * @plugindesc v1.05 - Display fogs and overlay on maps and battles.
 * @author Victor Sant
 *
 * @param Max Fogs
...
(function() {
	...
	if (Imported['VE - Basic Module']) {
		...
		VictorEngine.Parameters.MaxFogs = Number(parameters["Max Fogs"]) || 1;
	};
	...
	Spriteset_Base.prototype.update = function() {
		...
		for (var i = 1; i < VictorEngine.Parameters.MaxFogs; i++) { this.updateFogs(i) };
	};
	...
	Spriteset_Map.prototype.validFog = function(fogId) {
		var fog = $gameScreen.fog(fogId)
		if (!fog || fog.isBattleOnlyFog()) return false;
		return true;
	};
	...
	VictorEngine.FogAndOverlay.update = Spriteset_Battle.prototype.update;
	Spriteset_Battle.prototype.update = function() {
		VictorEngine.FogAndOverlay.update.call(this);
	...
	Spriteset_Battle.prototype.deleteFog = function(fogId) {
		...
		this.removeChild(this._fogEffects[fogId]);
		this._battleField._sortChildren();
		this._fogEffects[fogId] = null;
	};
	
	Spriteset_Battle.prototype.validFog = function(fogId) {
		var fog = $gameScreen.fog(fogId)
		if (!fog || !fog.isBattleFog()) return false;
		return true;
	};
...
(function() {
	...
	Object.defineProperty(Game_Fog.prototype, 'z', {
		get: function() {
	...
	Game_Fog.prototype.changeZoom = function(zoom, duration) {
		...
		if (duration === 0) this._zoom = this._zoomTarget;
	};
